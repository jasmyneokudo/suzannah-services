...
export const paymentPlans = [
  ...
  },
  {
    ...
    howItWorks: [
      ...
      "Client discusses and agrees on salary directly with their chosen candidate (starting from ₦70,000/month for  Nannies/Helps/Housekeepers (from ₦80,000 for live-out option), ₦150,000/month for cooks (from ₦170,000 for live-out option), ₦150,000/month for drivers (from ₦170,000 for live-out option), ₦180,000/month for Elder Caregivers (from ₦200,000 for live-out option)).",
      "We run medical tests before the staff resumes.",
      "Replacement is only valid for three (3) months after initial placemment",
    ],
    benefits: [
