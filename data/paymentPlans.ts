...
export const paymentPlans = [
  ...
  },
  {
    ...
    howItWorks: [
      ...
      "Client discusses and agrees on salary directly with their chosen candidate (starting from ₦70,000/month for Nannies/Helps/Housekeepers, ₦150,000/month for cooks, ₦150,000/month for drivers, ₦180,000/month for Elder Caregivers).",
