...
export const paymentPlans = [
  ...
  },
  {
    ...
    howItWorks: [
      ...
      "Client discusses and agrees on salary directly with their chosen candidate (starting from ₦70,000/month for  Nannies/Helps/Housekeepers (from ₦100,000 for live-out option), from ₦160,000/month for cooks (from ₦200,000 for live-out option), from ₦150,000/month for drivers (from ₦170,000 for live-out option), ₦180,000/month for Elder Caregivers (from ₦200,000 for live-out option)).",
